...
(function ($) {
        ...
        $(this).html(
          event.strftime(
            "" +
              ...
              '<div class="col"><span class="countdown-time countdown-time-last">%M</span><span class="countdown-text">Minutes</span></div>'
          )
        );
      });
    });
  ...
  if ($activity_table.length > 0) {
    ...
    $(".clear-table").append(
      '<a href="#" class="btn btn-primary btn-xs clear-activity">Clear Activity</a>'
    );
  }
