...
(function (root, factory) {
  ...
  function (window) {
    ...
    var notiflixInternalCSS = function () {
      if (
        notiflixInternalCSSCodes() !== null &&
        !window.document.getElementById("NotiflixInternalCSS")
      ) {
        // check doc head
        if (!notiflixHeadOrBodyCheck("head")) {
          return false;
        }
    ...
    var notiflixGoogleFont = function (use, family) {
      if (
        ...
        family.toLocaleLowerCase("en") === "quicksand"
      ) {
        // check doc head
        if (!notiflixHeadOrBodyCheck("head")) {
          return false;
    ...
    var NotiflixNotify = function (
      ...
      // check doc body
      if (!notiflixHeadOrBodyCheck("body")) {
        return false;
      }
      ...
      if (
        ...
        newNotifySettings = extendNotiflix(true, newNotifySettings, {
          closeButton: true,
          messageMaxLength: 100,
        });
        message =
          'HTML Tags Error: Your content length is more than "messageMaxLength" option.'; // message html error
      }
      ...
      if (newNotifySettings.backOverlay) {
        ...
        notifyOverlay.style.background =
        ...
        // if there is a backoverlay element and also if there is not a notify element with a callback, change backoverlay color by each type
          ...
          window.document.getElementById(notifyOverlay.id).style.background =
            theType.backOverlayColor || newNotifySettings.backOverlayColor;
        }
      }
      ...
      ntflxNotify.className =
        ...
        typeof callbackOrOptions !== "function"
          ...
          : "") +
        " " +
        (typeof callbackOrOptions === "function" ? "with-callback" : "") +
        " " +
    ...
    var NotiflixConfirm = function (
      ...
      // create a backup for new settings
      var newConfirmSettingsBackup = extendNotiflix(
        true,
        newConfirmSettings,
        {}
      );
      ...
      ntflxConfirmWrap.innerHTML =
        ...
        (typeof okButtonCallback === "function" ? "" : " full") +
        '" style="color:' +
      ...
      if (!window.document.getElementById(ntflxConfirmWrap.id)) {
        ...
        var getValidationInput = window.document.getElementById(
        ...
        if (getValidationInput) {
          ...
          getValidationInput.addEventListener("keyup", function (event) {
            ...
            if (thisValue !== theAnswer) {
              ...
              var thisEnter =
                (event.key || "").toLocaleLowerCase("en") === "enter" ||
                event.keyCode === 13;
              if (thisEnter) {
    ...
    var NotiflixLoading = function (
      ...
      // create a backup for new settings
      var newLoadingSettingsBackup = extendNotiflix(
        true,
        newLoadingSettings,
        {}
      );
      ...
      if (display) {
        ...
        var svgSizeAsDigit = parseInt(
          (newLoadingSettings.svgSize || "").replace(/[^0-9]/g, "")
        );
        var winWidth = window.innerWidth;
        var maxSvgWidthPx =
          svgSizeAsDigit >= winWidth
            ? winWidth - 40 + "px"
            : svgSizeAsDigit + "px";
        var svgIconHTML =
          '<div style="width:' +
      ...
      if (messageWrap) {
        ...
        if (newMessage.length > 0) {
          ...
          if (newMessage.length > newLoadingSettings.messageMaxLength) {
            newMessage =
              notiflixPlaintext(newMessage).substring(
                0,
                newLoadingSettings.messageMaxLength
              ) + "...";
          } else {
    ...
    var blockElmCount = 0;
    var NotiflixBlockUnblock = function (
      block,
      selector,
      iconType,
      messageOrOptions,
          ...
          if (eachBlockElement.length < 1) {
            ...
            if (message.length > 0) {
              if (message.length > newBlockSettings.messageMaxLength) {
                message =
                  notiflixPlaintext(message).substring(
                    0,
                    newBlockSettings.messageMaxLength
                  ) + "...";
              } else {
                message = notiflixPlaintext(message);
              }
            ...
            var selectorPos =
              typeof eachSelectorPos === "string"
                ? eachSelectorPos.toLocaleLowerCase("en")
                : "relative";

            var averageMinHeight =
              Math.round(parseInt(newBlockSettings.svgSize) * 1.25) + 40;
